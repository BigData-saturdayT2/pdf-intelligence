...
s3_csv_file = "validation_data.csv"
s3_key = s3_folder + s3_csv_file

# AWS Credentials
aws_access_key_id = "AKIA4SZHOGYEM2EOMZRQ"
aws_secret_access_key = "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"

# Amazon RDS Configuration
rds_endpoint = "my-s3-import-cluster.ch804m6acz5v.us-east-2.rds.amazonaws.com"
db_user = "admin"
db_password = "Assignment2-bdia"
db_name = "assignment_2"
table_name = 'gaia_validation_dataset'
